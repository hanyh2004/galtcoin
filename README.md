...
The [galtcoin/skycoindev-cli docker image](docker/images/dev-cli/README.md) is provided in order to make
easy to start developing Galtcoin. It comes with the compiler, linters, debugger
...
This file will be periodically uploaded to https://downloads.galtcoin.net/blockchain/peers.txt
...
The configuration is handled in `cmd/samoslab/galtcoin.go`
...
Releases and their signatures can be found on the [releases page](https://github.com/samoslab/galtcoin/releases).
