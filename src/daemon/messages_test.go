...
import (
	...
	"github.com/samoslab/galtcoin/src/cipher/encoder"
	...
	"github.com/samoslab/galtcoin/src/util"
...
func ExampleGivePeersMessage() {
	...
	var peer0 = *pex.NewPeer("118.178.135.93:6868")
	var peer1 = *pex.NewPeer("47.88.33.156:6868")
	var peer2 = *pex.NewPeer("121.41.103.148:6868")
	...
	tt := []struct {
		...
		},
		{
			...
			mockValue: daemonMockValue{
				...
				pubkey:     pubkey,
				addPeerArg: "121.121.121.121:6868",
				addPeerErr: nil,
			},
			intro: &IntroductionMessage{
				Mirror:  10001,
